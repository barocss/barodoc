...
Slug = path without locale and without extension: `guides/installation.md` → `guides/installation`. For expandable sidebar groups (e.g. a collapsible "Setup" section), see [Configuration → navigation](/docs/guides/configuration#navigation).
